...
Ivyclassic Product Collector - Collects and enriches product data from https://ivyclassic.com.

## Architecture

This project collects product information from Ivyclassic's website, including:
...
The Ivyclassic site configuration is embedded directly in `collector.py`.
...
```python
from collector import IvyclassicCollector
...
```bash
cd /Users/moosemarketer/Code/Python/collectors/ivyclassic

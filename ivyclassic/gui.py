...
Thread-safe GUI for running the Ivy Classic collector with queue-based communication.
...
from src.collector import Ivy ClassicCollector, SITE_CONFIG
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/ivyclassic.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = Ivy ClassicCollector()

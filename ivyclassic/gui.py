#!/usr/bin/env python3
"""
Ivy Classic Product Collector - GUI

Simple GUI for running the Ivy Classic collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.ivyclassic_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/ivyclassic.log",
}


class IvyclassicGUI:
    """GUI for Ivy Classic Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Ivy Classic Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="Ivy Classic Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://ivyclassic.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Catalog-based product enrichment",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/ivyclassic.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Ivy Classic Product Collector")
            self.log("=" * 60)

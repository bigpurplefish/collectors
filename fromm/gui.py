#!/usr/bin/env python3
"""
Fromm Family Foods Product Collector - GUI

Simple GUI for running the Fromm Family Foods collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.fromm_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/fromm.log",
}


class FrommGUI:
    """GUI for Fromm Family Foods Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Fromm Family Foods Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="Fromm Family Foods Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://frommfamily.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Manufacturer site with ingredients/nutrition",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/fromm.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Fromm Family Foods Product Collector")
            self.log("=" * 60)

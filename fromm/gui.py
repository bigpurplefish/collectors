...
Thread-safe GUI for running the Fromm Family Foods collector with queue-based communication.
...
from src.collector import Fromm Family FoodsCollector, SITE_CONFIG
...
DEFAULT_CONFIG = {
    ...
    "COLLECTOR_NAME": "Fromm Family Foods",
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/fromm.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = Fromm Family FoodsCollector()

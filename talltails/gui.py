#!/usr/bin/env python3
"""
Tall Tails Product Collector - GUI

Simple GUI for running the Tall Tails collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.talltails_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/talltails.log",
}


class TalltailsGUI:
    """GUI for Tall Tails Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Tall Tails Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="Tall Tails Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://talltailsdog.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Magento/Adobe Commerce with variant galleries",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/talltails.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Tall Tails Product Collector")
            self.log("=" * 60)

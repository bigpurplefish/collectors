...
Thread-safe GUI for running the Tall Tails collector with queue-based communication.
...
from src.collector import Tall TailsCollector, SITE_CONFIG
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/talltails.log"))

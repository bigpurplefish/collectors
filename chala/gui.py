...
Thread-safe GUI for running the Chala Handbags collector with queue-based communication.
...
from src.collector import Chala HandbagsCollector, SITE_CONFIG
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/chala.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = Chala HandbagsCollector()

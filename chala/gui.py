#!/usr/bin/env python3
"""
Chala Handbags Product Collector - GUI

Simple GUI for running the Chala Handbags collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.chala_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/chala.log",
}


class ChalaGUI:
    """GUI for Chala Handbags Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Chala Handbags Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="Chala Handbags Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://chalahandbags.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Shopify store with gallery extraction",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/chala.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Chala Handbags Product Collector")
            self.log("=" * 60)

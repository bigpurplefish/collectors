#!/usr/bin/env python3
"""
KONG Company Product Collector - GUI

Simple GUI for running the KONG Company collector with file pickers and configuration.
"""
...
from src.collector import KongCollector

CONFIG_PATH = os.path.expanduser("~/.kong_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/kong.log",
}


class KongGUI:
    """GUI for KONG Company Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("KONG Company Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="KONG Company Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://kongcompany.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Product catalog with media variants",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/kong.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting KONG Company Product Collector")
            self.log("=" * 60)

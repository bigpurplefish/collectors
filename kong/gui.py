...
Thread-safe GUI for running the KONG Company collector with queue-based communication.
...
from src.collector import KONG CompanyCollector, SITE_CONFIG
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/kong.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = KONG CompanyCollector()

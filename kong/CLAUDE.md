...
KONG Company Product Collector - Collects and enriches product data from https://www.kongcompany.com.

## Architecture

This project collects product information from KONG Company's website, including:
...
The KONG Company site configuration is embedded directly in `collector.py`.
...
```python
from collector import KongCollector
...
```bash
cd /Users/moosemarketer/Code/Python/collectors/kong
pyenv local kong

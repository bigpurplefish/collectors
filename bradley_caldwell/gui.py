#!/usr/bin/env python3
"""
Bradley Caldwell Product Collector - GUI

Simple GUI for running the Bradley Caldwell collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.bradley_caldwell_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/bradley_caldwell.log",
}


class BradleyCaldwellGUI:
    """GUI for Bradley Caldwell Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Bradley Caldwell Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="Bradley Caldwell Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://www.bradleycaldwell.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Catalog-based product enrichment (no scraping)",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/bradley_caldwell.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Bradley Caldwell Product Collector")
            self.log("=" * 60)
            ...
            collector = BradleyCaldwellCollector()

...
Thread-safe GUI for running the Bradley Caldwell collector with queue-based communication.
...
from src.collector import Bradley CaldwellCollector, SITE_CONFIG
...
DEFAULT_CONFIG = {
    ...
    "COLLECTOR_NAME": "Bradley Caldwell",
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/bradley_caldwell.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = Bradley CaldwellCollector()

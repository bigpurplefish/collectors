...
Simple GUI for running the Orgill collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.orgill_collector_gui.json")
...
class OrgillGUI:
    """GUI for Orgill Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Orgill Product Collector")
    ...
    def create_widgets(self):
        ...
        tb.Label(
            info_frame,
            text="Site: https://orgill.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="Requires authentication, portal scraping",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/orgill.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Orgill Product Collector")
            self.log("=" * 60)

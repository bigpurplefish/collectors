...
Orgill Product Collector - Collects and enriches product data from https://www.orgill.com.

## Architecture

This project collects product information from Orgill's website, including:
...
The Orgill site configuration is embedded directly in `collector.py`.
...
```python
from collector import OrgillCollector
...
```bash
cd /Users/moosemarketer/Code/Python/collectors/orgill
pyenv local orgill

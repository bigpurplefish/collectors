...
Thread-safe GUI for running the Ethical Pet collector with queue-based communication.
...
from src.collector import Ethical PetCollector, SITE_CONFIG
...
File should include product information with UPCs and names.\n\nTip: Use the Browse button to easily find your file.",
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/ethical.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = Ethical PetCollector()

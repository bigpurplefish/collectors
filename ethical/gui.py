#!/usr/bin/env python3
"""
Ethical Pet Product Collector - GUI

Simple GUI for running the Ethical Pet collector with file pickers and configuration.
"""
...
CONFIG_PATH = os.path.expanduser("~/.ethical_collector_gui.json")

DEFAULTS = {
    "input_json_file": "",
    "output_json_file": "",
    "log_file": "logs/ethical.log",
}


class EthicalGUI:
    """GUI for Ethical Pet Product Collector."""

    def __init__(self, root):
        self.root = root
        self.root.title("Ethical Pet Product Collector")
    ...
    def create_widgets(self):
        ...
        title = tb.Label(
            main_frame,
            text="Ethical Pet Product Collector",
            font=("Arial", 16, "bold"),
            bootstyle="primary"
        )
        ...
        tb.Label(
            info_frame,
            text="Site: https://ethicalpet.com",
            font=("Arial", 10)
        ).pack()

        tb.Label(
            info_frame,
            text="WooCommerce site with Selenium support",
            font=("Arial", 9),
            bootstyle="secondary"
        ).pack()
    ...
    def populate_from_config(self):
        ...
        self.log_var.set(self.config.get("log_file", "logs/ethical.log"))
    ...
    def collect_products(self):
        ...
        try:
            ...
            self.log("=" * 60)
            self.log("Starting Ethical Pet Product Collector")
            self.log("=" * 60)

...
Ethical Products (SPOT) Product Collector - Collects and enriches product data from https://www.ethicalpet.com.

## Architecture

This project collects product information from Ethical Products (SPOT)'s website, including:
...
The Ethical Products (SPOT) site configuration is embedded directly in `collector.py`.
...
```python
from collector import EthicalCollector
...
```bash
cd /Users/moosemarketer/Code/Python/collectors/ethical
pyenv local ethical

...
Thread-safe GUI for running the Coastal Pet collector with queue-based communication.
...
from src.collector import Coastal PetCollector, SITE_CONFIG
...
def build_gui():
    ...
    log_var = tb.StringVar(value=cfg.get("LOG_FILE", "logs/coastal.log"))
    ...
    def start_processing():
        ...
        def worker():
            ...
            try:
                ...
                collector = Coastal PetCollector()
